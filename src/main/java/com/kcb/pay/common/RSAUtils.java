...
//      PKCS8EncodedKeySpec pkcs8EncodedKeySpec = new PKCS8EncodedKeySpec(decode); //java底层 RSA公钥只支持X509EncodedKeySpec这种格式
    ...
    public static void main(String[] args) throws Exception {
        String ss = "jVDUaTjF+UFut09BXERrnFMZl5dW0dhLBbL5NzkfVL+46oZ3027oVgpEoXCHMJGFgMXOLSx/yIY5tE7sjUGQPxebggLtTRe0Mv4k9TDPaDn+3lK1usKWGmdiG2ut+Uc4N572tJklNnbFTIxCEcvEncEoKz1R/7HQZ94MfIqp6IyBbNQPtUsZeD8aWZFf9vVE3FryEi4FiJSrRwXDAf7VP5wIT78+jSq3TxJn4xC4S8YP39jEZIUjKQ==";
//        String ss = "e8986ae53e76e7514ebc7e8a42e81e6cea5b6280fb5d3259d5f0a46f9f6e090c";
...
//        String sign = SHA256RSAUtils.rsa256Sign(ss, getPrivateKey(keyMap), SIGNATURE_ALGORITHM, "UTF-8");
